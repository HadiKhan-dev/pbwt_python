...
bin_data = degrade_data(bin_data,0.01)
...
def combine_extracted_datas(pbwt,extract_list, frequency_bins,
    ...
    with multiprocessing.Pool(75) as pool:
...
def run_log_res(combined,bucket_name,bucket_midpoint):
    ...
    write_list.append(tot_string)

    sys.stdout.flush()
    
    return (t,tot_string)

def evaluate(func,arg1,arg2):
    return func(bucket_name=arg1,bucket_midpoint=arg2)
...
run_args.extend(zip(eval_funcs,buckets,bucket_mids))

with multiprocessing.Pool(4) as pool:
    results = pool.starmap(evaluate,run_args)
    
for item in results:
    write_list.append(item[1])


f = open("log_res/outputs_test6.txt","wb")
...
# %%
z = [(5, 0.006997432280797379), (15, 9.614035087719298), (25, 20.461384152457374), (35, 38.51851851851852), (45, 46.55436447166922), (55, 56.8624074392974), (65, 64.91076568796775), (75, 76.981852913085), (85, 83.75605585636933), (95, 99.9916335317405)]

plt.scatter([i[0] for i in z],[i[1] for i in z])
plt.plot([i for i in range(100)],color="r")
plt.title("Calibration")
plt.xlabel("Predicted alternate")
plt.ylabel("Actual alternate")
plt.show()
